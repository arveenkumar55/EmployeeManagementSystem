...
public void newPage(String newValue) {
	...
	System.out.println(newValue);   
	 ...
	 else if(newValue.equals("ViewPerformance"))
	 	{
		
		 changePage("view/SearchEmployee.fxml");
		}
	
	 else if(newValue.equals("AssignProject"))
	 	{
		
		 changePage("view/AssignProject.fxml");
		}
	 else if(newValue.equals("AddProject"))
	 	{
		 changePage("view/AdProject.fxml");
		}
...
private void changePage(String string) {
	...
	Parent rootLayout = null;
	 ...
	 if(string.equals("view/PasswordChange.fxml"))
	 	{
		   PasswordChangController controller=new PasswordChangController();
		   controller.SetEmp_id(emp_id);
	 	}
		
	 else if(string.equals("view/SearchEmployee.fxml"))
	 	{
		   SearchEmployeeController controller=new SearchEmployeeController();
		   controller.setEmpID(emp_id);
	 	}
	 
	 else if(string.equals("view/viewAttendence.fxml"))
	 	{
	    ...
	    else if(string.equals("view/AssignProject.fxml"))
	 	{
	       AssignProjectController controller=new  AssignProjectController();
	  	   controller.setEmpId(emp_id);
		}
	    
	    else if(string.equals("view/AdProject.fxml"))
	 	{
